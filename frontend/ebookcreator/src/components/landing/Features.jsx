        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8 relative'>
            <div className='text-center mb-20 space-y-4'>
                ...
                <p className='text-base text-gray-600 max-w-2xl mx-auto'>
                    Our platform is packed with the powerful features to help you write,
                ...
                {FEATURES.map((feature, index) => {
                    ...
                    return (
                        <div key={index} className='group relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-y-1'>
                            <div className='absolute inset-0 bg-gradient-to-r from-violet-50/0 to-purple-50/0 group-hover:from-violet-50/50 group-hover:to-purple-50/30  rounded-2xl transition-all duration-200'></div>
            ...
            <div className='text-center nt-16'>
                <p className='text-gray-600 mb-6 '>Ready To get Started?</p>
                <a href='/signup' className='inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30  hover:shadow-violet-500/50 hover:sacle-105 transition-all duration-200'>
