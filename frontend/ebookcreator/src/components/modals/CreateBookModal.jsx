...
const CreateBookModal = ({ isOpen, onClose, onBookCreated }) => {
  ...
  const [isGenerateingOutline, setIsGenerateingOutline] = useState(false);
  ...
  const handleFinalizedBook = async () => {
        ...
        <div className="space-y-5">
          ...
          <div className="flex justify-end pt-4">
            <Button
              ...
              isLoading={isGenerateingOutline}
              icon={<Sparkles />}
            >
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={handleFinalizedBook} isLoading={isFinalizingBook}>
                Create Book
              </Button>
            </div>
          </div>
