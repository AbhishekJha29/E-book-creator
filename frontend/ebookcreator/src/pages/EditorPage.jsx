  ...
  const handleExportPDF = async () => {
     ...
     try {
      ...
      toast.success("PDF export started!");
       ...
       toast.dismiss();
      toast.success("Failed to export PDF.");
     }
  };
  ...
  const handleExportDOC = async () => {
     ...
     try {
      ...
      toast.success("Document export started!");
       ...
       toast.dismiss();
      toast.success("Failed to export Document.");
     }
  };
      ...
      <div className="flex bg-slate-50 font-sans relative min-h-screen">
        {isSidebarOpen && (
          <div className="fixed inset-0 z-40 flex md:hidden" role="dialog" aria-modal="true">
            ...
            <div className="flex shrink-0 w-1/4" aria-hidden="true"></div>
          </div>
        )}
        ...
        <main className="flex-1 h-full flex flex-col">
          <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-b-slate-200 p-3 flex justify-between items-center">
